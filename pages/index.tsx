			...
			<div className="text-primary-500">
				<div className="text-left sm:pt-11.2 leading-7 sm:leading-10">
					...
					<h1 className="font-extraBold text-primary-800 dark:text-primary-200">
						Abraham Calsin.
						<span className="block text-primary-600 dark:text-primary-400 mt-0.7">
							Construyo cosas para la web.
						</span>
					</h1>

					<p className="mt-0.7 font-semiBold">
						Soy Desarrollador Frontend, apasionado por la programación, creo proyectos de código
						abierto.
					</p>
					...
					<div className="flex justify-start gap-1.7">
						...
						<SocialNetworkButton
							...
							svgSocialNetwork={<GithubSocialNetwork />}
						/>
					</div>
				</div>
